<?php
    ...
    $result_desktops = "SELECT * FROM desktop WHERE loja='LOJA-01'";
    $resultado_desktops = mysqli_query($mysqli, $result_desktops);
    

   
    $result_monitores = "SELECT * FROM monitores WHERE loja='LOJA-01'";
    $resultado_monitores = mysqli_query($mysqli, $result_monitores);
    
    
    $result_impressora = "SELECT * FROM impressora WHERE lojas='LOJA-01'";
    $resultado_impressora = mysqli_query($mysqli, $result_impressora);
    
   
    $result_impressora_bulk = "SELECT * FROM impressora_bulk WHERE lojas='LOJA-01'";
    $resultado_impressora_bulk = mysqli_query($mysqli, $result_impressora_bulk);
    
   
    $result_balanca = "SELECT * FROM balanca_caixa WHERE lojas='LOJA-01'";
    ...
    $result_imp_go = "SELECT * FROM impressora_gondolas WHERE lojas='LOJA-01'";
      ...
      <div class="card text-white bg-dark mb-3" style="max-width: 14rem;">
       ...
       <nav aria-label="...">
            ...
            <li class="page-item"><a class="page-link" href="./cadastro.php">Inventário Geral</a></li>
                ...
                <span class="page-link">LOJA - 01</span>
                </li>
                ...
                <div class="tab-pane fade show active" id="list-desktop" role="tabpanel" aria-labelledby="list-desktop-list">
                                     ...
                                     <table class="table table-dark table-striped table-responsive ">
                                        <thead>
                                            ...
                                            <th scope="col">OBS</th>
                                            <th scope="col"> 
                                            <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_desk1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                            </th>
                ...
                <div class="tab-pane fade" id="list-monitor" role="tabpanel" aria-labelledby="list-monitor-list">
                                            <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_monitor1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
                ...
                <div class="tab-pane fade" id="list-impcaixa" role="tabpanel" aria-labelledby="list-impcaixa-list">
                                           <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_impcx1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
                ...
                <div class="tab-pane fade" id="list-impat" role="tabpanel" aria-labelledby="list-impat-list">
                                            <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_impbk1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
                ...
                <div class="tab-pane fade" id="list-bacx" role="tabpanel" aria-labelledby="list-bacx-list">
                                            <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_bacx1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
                ...
                <div class="tab-pane fade" id="list-baat" role="tabpanel" aria-labelledby="list-baat-list">
                                            <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_baat1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
                ...
                <div class="tab-pane fade" id="list-go" role="tabpanel" aria-labelledby="list-go-list">
                                            <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_impgo1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
                ...
                <div class="tab-pane fade" id="list-tef" role="tabpanel" aria-labelledby="list-tef-list">
                                            <table class="table table-dark table-striped table-responsive">
                                                <thead>
                                                    ...
                                                    <th scope="col">OBS</th>
                                                    <th scope="col"> 
                                                    <?php echo '<td><a class="btg btn btn-xs btn-success" href="./exc/excel_tef1.php"><b>ARQUIVO EXCEL</b></a></td>'; ?>
                                                    </th>
